  ...
  },
  {
    ...
    translations: {
      ...
      kk: {
        ...
        challenge: 'Демалыс орны қонақтарды қабылдады, бірақ брондау тек ауызша және жеке қоңыраулар арқылы жүргізілді. Сайт та, ашық қолжетімділіктегі өзекті бағалар да болған жоқ — бөлме құнын білу үшін клиенттер директке жазып, жауап күтуге мәжбүр болды.',
